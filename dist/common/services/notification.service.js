...
class NotificationService {
    client;
    constructor() {
        const serviceAccount = JSON.parse((0, node_fs_1.readFileSync)((0, node_path_1.resolve)(__dirname, "../../config/social-app-5fa50-firebase-adminsdk-fbsvc-4b962838d9.json")));
