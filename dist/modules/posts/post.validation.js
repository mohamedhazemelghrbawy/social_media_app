...
exports.createPostSchema = {
    body: z
        ...
        availability: z
            .enum(post_enum_js_1.Availability_Enum)
            .default(post_enum_js_1.Availability_Enum.friends),
        allowComment: z
            .enum(post_enum_js_1.Allow_Comment_Enum)
            .default(post_enum_js_1.Allow_Comment_Enum.allow),
    })
...
exports.updatePostSchema = {
    body: z
        ...
        allowComment: z
            .enum(post_enum_js_1.Allow_Comment_Enum)
            .default(post_enum_js_1.Allow_Comment_Enum.allow),
        availability: z.enum(post_enum_js_1.Availability_Enum).default(post_enum_js_1.Availability_Enum.public),
        tags: z.array(generalRules_js_1.generalRules.id).optional(),
    })
        .superRefine((args, ctx) => {
        if (!args.content &&
